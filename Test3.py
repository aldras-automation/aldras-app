...
class EditFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.fg_bottom = wx.FlexGridSizer(2, 2, 10, 10)  # -------------------------------------------------------------

        self.vbox_action = wx.BoxSizer(wx.VERTICAL)  # sizer for action sidebar

        # add load all button
        load_all_sizer = wx.BoxSizer(wx.HORIZONTAL)
        self.load_all_btn = wx.Button(self, label='Load All', style=wx.BU_EXACTFIT)
        self.load_all_btn.Bind(wx.EVT_BUTTON, lambda event: self.load_all_commands())
        config_status_and_tooltip(self, self.load_all_btn, 'Load all commands', 'Load all commands')
        load_all_sizer.AddSpacer(20)
        load_all_sizer.Add(self.load_all_btn, 1, wx.SOUTH, 5)
        self.vbox_action.Add(load_all_sizer, 0, wx.EXPAND)
        ...
        self.vbox_action.AddStretchSpacer(3)
        ...
        self.test_box = wx.BoxSizer(wx.VERTICAL)
        self.test_box.Add(wx.StaticText(self, label='test'))
        ...
        self.fg_bottom.AddGrowableRow(1, 0)
    ...
    def render_lines(self, first_render=False, render_all=False):
        ...
        if num_lines_render == 1000:
            self.loading_dlg = wx.ProgressDialog('Aldras Workflow Loading',
        ...
        if num_lines_render == 1000 or len(self.lines) <= len(self.edit_row_widget_sizers):
            self.plus_btn.Enable()
    ...
    def load_all_commands(self):
        self.render_lines(render_all=True)
        self.load_all_btn.Show(False)
        self.Layout()
